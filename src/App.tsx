...
import { 
  Sun, Moon, Code2, Palette, Languages, Mail, Github, Linkedin, Loader, ExternalLink,
  BookOpen, FileJson, Coffee, Cpu, Figma, Workflow,  
  FileCode, Globe, Database, Server, SmartphoneNfc, 
  Smartphone, Blocks, GitBranch, PanelRight, Cloud, Flame, PenTool,
  Menu, X, ChevronDown
} from 'lucide-react';
...
function App() {
  ...
  const projects = [
    {
      title: "Taskmate",
      shortDescription: "Mobile app connecting home service providers with clients in the community",
      description: "Taskmate is an innovative mobile application designed to bridge the gap between home service providers and clients within the community. The app offers a seamless platform where users can easily find and connect with trusted professionals for various home services such as cleaning, plumbing, electrical repairs, and more. Taskmate enhances convenience and reliability for both service providers and clients, fostering a stronger and more connected community.",
      image: "/assets/taskmate-logo.jpg",
      tools: ["Flutter", "Firebase", "Dart", "Kotlin", "Git", "GitHub"]
    },
    {
      title: "Centsible",
      shortDescription: "Mobile app for tracking personal finances and budgeting",
      description: "Centsible is a mobile application for tracking personal finances, allowing users to manage their budget, track savings, and monitor expenses and bills. With user-friendly features, Centsible simplifies budgeting to help users maintain financial control and meet their savings goals effectively.",
      image: "assets/centsible-logo.jpg",
      tools: ["Flutter", "Firebase", "Dart", "Kotlin", "Git", "GitHub"]
    },
    {
      title: "Barangay Document Request System",
      shortDescription: "Community platform for requesting and managing barangay documents online",
      description: "The Barangay Document Request System is a community-focused platform that enables residents to request and manage barangay documents online. This system streamlines the document request process, making it more accessible and efficient for local residents and barangay officials.",
      image: "assets/barangay-document-request.jpg",
      tools: ["HTML5", "CSS3", "JavaScript", "PHP", "MySQL", "Bootstrap", "Git", "GitHub"]
    },
    {
      title: "Hansa Hotel Management System",
      shortDescription: "System for managing hotel operations including reservations and check-ins",
      description: "This Hotel Management System is designed to optimize hotel operations by managing reservations, check-ins, check-outs, and customer records. It enhances the efficiency of hotel staff and improves customer service by offering a centralized, and automated management tool.",
      image: "assets/hansa-hotel.jpg",
      tools: ["HTML5", "CSS3", "JavaScript", "PHP", "MySQL", "Bootstrap", "Git", "GitHub"]
    },
    {
      title: "GUFC Solane",
      shortDescription: "Web-based sales and inventory system for a local gas company",
      description: "GUFC Solane is a web-based Sales and Inventory Management System designed for a local gas company. Developed in collaboration with PUP San Juan students, the system streamlines inventory tracking, sales processing, and order management. It provides real-time stock monitoring, automated reporting, and an intuitive interface to enhance operational efficiency and minimize discrepancies in inventory and sales records.",
      image: "assets/solane.jpg",
      tools: ["Laravel", "PHP", "MySQL", "Vue.js", "Node.js", "Bootstrap", "Git", "GitHub"]
    },
    {
      title: "Homease",
      shortDescription: "Web-based home service provider booking system",
      description: "Homease is a web-based home service provider booking platform developed for one of my clients. It connects homeowners with professional service providers for various home maintenance tasks such as plumbing, electrical work, cleaning, and more. The platform offers seamless booking, real-time availability checking, secure payments, and user reviews to ensure quality service. Homease simplifies the process of finding reliable home service providers, enhancing convenience for both customers and service professionals.",
  ...
  const skills = {
    ...
    tools: [
      ...
      { name: "Command Prompt", icon: <PanelRight className="text-gray-700" /> },
    ...
    media: [
      ...
      { name: "Adobe Illustrator", icon: <PenTool className="text-orange-500" /> },
  ...
  const ContactForm = ({ isDarkMode }) => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        setErrorMessage('Oops! There was an error sending your message. Please try again later.');
      } finally {
      ...
      <div className="mt-8 max-w-md mx-auto">
        {isSubmitted ? (
          <div className="p-6 rounded-lg text-center border-2 border-green-500/50 bg-green-500/20">
            ...
            <p className="text-sm mb-3">Thank you for reaching out. I'll get back to you as soon as possible.</p>
            <p className="text-xs opacity-75">An auto-reply has been sent to your email.</p>
          </div>
        ) : (
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          <motion.h2 
            className="text-2xl text-white mb-2 opacity-90"
      ...
      >
        ...
        >
          ...
          <p className="text-base md:text-lg leading-relaxed mb-2">
            I'm a passionate <strong>Web and Mobile Developer</strong>, specializing in creating
            responsive, user-friendly applications that solve real-world problems. Check out some of my work in the Projects section.
          </p>

          <p className="text-base md:text-lg leading-relaxed mb-2">
            My expertise spans the full development stack, from designing intuitive user interfaces to implementing
            robust backend solutions. Feel free to connect with me on {" "} 
            <a href="https://linkedin.com/in/jeeems" target="_blank" rel="noopener noreferrer" 
          ...
          <p className="text-base md:text-lg leading-relaxed mb-2">
            I'm open to <strong>Job</strong> opportunities, freelance projects, and collaborations where I can contribute my skills and expertise.
            If you have a great project idea or need help with an existing project, don't hesitate to reach out!
          </p>
      ...
      >
        ...
        <h2 
          ...
          style={{ transform: `translateX(${Math.max(0, (scrollY - 1300) * -0.1)}px)` }}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {Object.entries(skills).map(([category, skillList], index) => (
            ...
            >
              <h3 className="text-lg md:text-xl font-semibold mb-4 capitalize">{category}</h3>
                  ...
                  >
                    <div className="flex items-center h-8">
                      ...
                      <div className="flex items-center justify-center w-0 opacity-0 group-hover:w-6 group-hover:opacity-100 transition-all duration-300 ease-in-out pl-0 group-hover:pl-2">
                        <div className="flex-shrink-0 w-2 h-5"> {/* Reduced from w-4 h-4 to w-3 h-3 */}
                          {skill.icon}
                        </div>
                      </div>
    ...
    >
      ...
      <h2 
        className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 flex items-center gap-2 relative"
        style={{ transform: `translateX(${Math.max(0, (scrollY - 2100) * -0.1)}px)` }}
      >
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                <h4 className="text-lg font-semibold mb-2 flex items-center gap-2">
                  <Palette className="w-5 h-5 text-[#f29028]" /> Project Overview
                </h4>
              ...
              <div>
                <h4 className="text-lg font-semibold mb-2 flex items-center gap-2">
                  <Code2 className="w-5 h-5 text-[#f29028]" /> Technologies Used
                </h4>
                <div className="flex flex-wrap gap-2">
      ...
      >
        ...
        <div 
          className="relative p-6 md:p-8 rounded-2xl border border-white/20 shadow-xl text-center
            hover:shadow-2xl hover:border-white/30 transition-all duration-300 ease-in-out transform hover:-translate-y-1"
          style={{ transform: `translateY(${Math.max(0, (scrollY - 2900) * -0.05)}px)` }}
        >
      ...
      <footer 
        ...
        style={{ transform: `translateY(${Math.max(0, (scrollY - 3200) * -0.02)}px)` }}
      >
        <div 
          className="absolute w-full h-px bg-gradient-to-r from-transparent via-[#f29028]/30 to-transparent top-0 left-0"
          style={{ transform: `scaleX(${Math.min(1, Math.max(0.3, scrollY / 3300))})` }}
        ></div>
        <p className="opacity-70">© {new Date().getFullYear()} Jemuel Olaybar. All rights reserved.</p>
      </footer>
    </div>
  );
}
